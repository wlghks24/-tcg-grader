...
REQUIRED_FILES = (
    ...
    "card_identity_recognition.py", "card_identity_recognition.js", "card_metadata_classifier_v326.js", "card_identity_learning.json", "card_identity_reference_catalog.json",
