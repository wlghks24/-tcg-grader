...
async function submit(event){
 ...
 try{
  ...
  markPreviewRegistered();
  if(status)status.textContent=data.duplicate?'기존 앞면 등록건에 뒷면 사진을 확인했습니다. 아래 미리보기는 방금 선택한 사진입니다.':'앞면·뒷면 2장 등록 완료 · 아래에서 방금 등록한 사진을 확인할 수 있습니다.';
