...
def _commands():
    ...
    return rows
def run(passes:int):
    passes=max(1,min(5,int(passes))); payload={"schema_version":1,"engine":"current-main-v322-promo-identity-generation-market-precision","started_at":_now(),"passes":[],"ok":False}
