...
class PsaManualProofV166Tests(unittest.TestCase):
    ...
    def test_pending_candidate_cannot_use_existing_slab_grade_as_official_proof(self):
        ...
        self.assertFalse(result['slab_grade_fallback'])
        self.assertFalse(result['grade_match'])
