#!/usr/bin/env python3
"""Regression guards discovered by the 2026-09-04 live sample.

These tests protect semantic invariants that source verification alone cannot prove:
- an ad-hoc live sample is never a 10:00 baseline;
- FX values retain their actual as-of time;
- incomplete market evidence cannot be promoted to Top10.
"""
...
def main():
    bad = {
        ...
        'fx': {'USD/KRW': {'as_of_kst':'2026-09-04T15:30:00+09:00','display_label_time_kst':'2026-09-04T10:00:00+09:00'}},
        'games': {'pokemon': {'verified_market_candidate_count': 3, 'requested_top_n': 10, 'ranking_label': 'Market Watch Top 10'}}
    }
    ...
    good = {
        'run_kind': 'live_sample',
        'baseline_id': None,
        'fx': {'USD/KRW': {'as_of_kst':'2026-09-04T15:30:00+09:00','display_label_time_kst':'2026-09-04T15:30:00+09:00'}},
        'games': {'pokemon': {'verified_market_candidate_count': 3, 'requested_top_n': 10, 'ranking_label': 'Market Watch 3'}}
    }
