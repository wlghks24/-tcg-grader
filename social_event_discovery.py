...
def main() -> dict:
    ...
    if not merged and previous and isinstance(previous.get("items"), list):
        merged = previous.get("items", [])[:candidate_limit()]
    payload = {
