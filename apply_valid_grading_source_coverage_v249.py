...
TEST = ROOT / "test_valid_grading_source_coverage_v249.py"
...
for name, (old, new) in anchors.items():
    ...
    if count != 1:
        raise SystemExit(f"{name} anchor mismatch: {count}")
...
if __name__ == "__main__":
    unittest.main()
''', encoding="utf-8")
print("patched valid grading source coverage and wrote v249 regression")
