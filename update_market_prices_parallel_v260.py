...
MARKET_REFERENCE_SOURCES = (
    ...
    },
    {
        ...
        "name": "Collectr",
        "region": "US_GLOBAL",
        "region_label": "글로벌 · 포트폴리오",
        "evidence_group": "guide",
        "evidence_label": "카드·밀봉·등급품 시세 가이드",
        "games": ["Pokémon", "ONE PIECE"],
        "url": "https://app.getcollectr.com/",
        "search_url_template": "",
        "recommended": True,
        "auto_collected": False,
        "note": "Raw·밀봉·등급카드 가격과 언어별 포트폴리오 흐름을 글로벌 참고값으로 확인",
    },
    {
        "id": "card_ladder",
        "name": "Card Ladder",
        ...
        "region_label": "미국 · 글로벌",
        "evidence_group": "guide",
        "evidence_label": "공개 판매이력 · 장기 시장가이드",
        "games": ["Pokémon", "ONE PIECE"],
        "url": "https://www.cardladder.com/ladder",
        "search_url_template": "",
        "recommended": True,
        "auto_collected": False,
        "note": "eBay·Goldin·Heritage·Fanatics 등 공개 판매이력을 묶어 장기 시세와 최근 판매를 교차확인",
    },
    {
        "id": "tcgfish",
        "name": "TCGFish",
        "region": "US_GLOBAL",
        "region_label": "글로벌 · 포켓몬",
        "evidence_group": "guide",
        "evidence_label": "일일 시세 · 시장지수",
        "games": ["Pokémon"],
        "url": "https://www.tcgfish.net/pokemon-cards",
        "search_url_template": "",
        "recommended": False,
        "auto_collected": False,
        "note": "포켓몬 Raw/미감정 기준 일일 시세·시장지수·세트 모멘텀을 보조 지표로 확인",
    },
    {
        "id": "pokevalues_jp",
        "name": "PokeValues Japanese",
        "region": "JP",
        "region_label": "일본 · 포켓몬",
        "evidence_group": "guide",
        "evidence_label": "일본판 세트별 가격 가이드",
        "games": ["Pokémon"],
        "url": "https://www.pokevalues.com/japanese",
        "search_url_template": "",
        "recommended": False,
        "auto_collected": False,
        "note": "일본판 포켓몬 세트별 가격을 글로벌 참고값으로 비교할 때 사용하는 보조 가이드",
    },
    {
        "id": "cardmarket",
        "name": "Cardmarket",
