...
class FeatureCategoryNavigationV26Tests(unittest.TestCase):
    ...
    def test_clear_home_identity_precedes_category_picker(self):
        ...
        self.assertIn('id="tabletManagerTitle">📱 태블릿 관리기</h3>', self.html)
        ...
        self.assertIn('new Set(["v23dual", "v16update", "v20live", "tabletServerGuide"])', self.js)
        self.assertGreaterEqual(self.html.count('data-tablet-click="v23check"'), 2)
        self.assertEqual(self.html.count('data-tablet-click="v20issues"'), 1)
