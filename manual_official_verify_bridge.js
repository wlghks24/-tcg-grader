...
function style(){
 ...
 .gpd-official-fallback{margin-top:12px}
 ...
 .gpd-official-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;padding:10px;border:1px solid #99f6e4;background:#f0fdfa;border-radius:13px;align-items:center;margin-top:8px}
...
async function render(){
 ...
 try{
  ...
  const payload=await loadStatus();if(!payload){box.hidden=true;box.innerHTML='';return}
