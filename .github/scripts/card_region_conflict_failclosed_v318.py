...
src = src.replace(
    ...
    'current-main-v318-card-region-conflict-failclosed',
    1,
)
write(path, src)
...
class CardRegionConflictFailClosedV318Tests(unittest.TestCase):
    def test_server_conflicting_edition_never_returns_automatic_best(self) -> None:
        candidate = {
            "market_key": "KR|PIKACHU|HIT", "region": "KR", "game": "pokemon",
            "card_name": "Pikachu", "card_number": "025", "confidence": 0.999,
            "matched_by": "confirmed_exact_image",
        }
        payload = {
            "game": "pokemon", "region": "KR",
    ...
    def test_non_conflicting_edition_keeps_normal_best_candidate(self) -> None:
        candidate = {
            "market_key": "KR|PIKACHU|HIT", "region": "KR", "game": "pokemon",
            "card_name": "Pikachu", "card_number": "025", "confidence": 0.99,
...
'''
write("test_card_region_conflict_failclosed_v318.py", test)
print("v318 patch applied")
