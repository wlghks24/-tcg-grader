...
PUBLIC_STATIC_FILES={
    'index.html','icon.svg','manifest.webmanifest','sw.js','feature_category_nav.css','feature_category_nav.js','ui_app_shell_v272.css','ui_app_shell_v272.js','grading_vision_engine.js','grading_accuracy_v99.js','card_metadata_classifier_v328.js','card_identity_recognition.js','manual_dual_photo_bridge.js',
